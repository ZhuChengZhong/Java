...
public class Test {
	...
	//	String sourceFile="e://test.java";
		...
		String sourceFile="e://compress/12345.txt";
		String target="e://compress/12345-copy.txt";
		File dir=new File("e://compress");
		String[] files=dir.list();
		for(int i=0;i<files.length;i++){
			test("e://compress/"+files[i],"e://lzcompress/lz_"+files[i], cp);
		}
	}
